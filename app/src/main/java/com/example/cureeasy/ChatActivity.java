...
Map<String,String> getIntents;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // user id of current user detected from Shared Preferences
...
messages=new ArrayList<>();
        ...
        // STORING OPPOSITE USER VALUE LIKE NAME ID TOKEN TO BE SENT TO REALTIME DATABASE
        getArrayIntent();
        ...
        getstartchat(from,to)
                .addOnCompleteListener(new OnCompleteListener<Map<String, ArrayList<Map<String,String>>>>() {
                    ...
                    public void onComplete(@NonNull Task<Map<String, ArrayList<Map<String,String>>>> task) {
                        ...
                        // Setting up Recycler view when succesfull Read Previous Chat
    ...
    // function to read chat message hhtops function deployed on cloud
