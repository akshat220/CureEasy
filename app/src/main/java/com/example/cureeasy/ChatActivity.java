...
messages=new ArrayList<>();
    ...
    public void onClick(View v) {
        ...
        {chat_msg.setText("");
            ...
            firebasechat(uuid,msg,getIntents.get("userid"),name,getIntents.get("token"));
        }
    }

    public void firebasechat(final String from,final String m,final String to,String name,String token)
    {
        result2=new HashMap<String,String>();
        mFunctions = FirebaseFunctions.getInstance();
        startchat(from,m,to,name,token)
    ...
    private Task<Map<String,String>> startchat(String fro,String m,String t,String name,String token) {
        // Take from Intent.
